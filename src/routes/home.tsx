    ...
    return (
        <main className="w-full pt-10 pb-32 px-10 lg:px-28 flex flex-col bg-white dark:bg-zinc-900 dark:text-white min-h-screen">
            ...
            <section className="my-10">
                <h1 className="text-2xl font-medium md:text-3xl">My name is <span className='text-emerald-500'>Zach McMullen</span> and welcome to my portfolio!</h1>
            ...
            <ul className="mt-5 flex">
                <li><a className='mr-3 text-emerald-500 hover:text-emerald-600 text-lg' href="https://www.linkedin.com/in/zach-mcmullen-ba3a2621b/"><i className="fa-brands fa-linkedin-in"></i></a></li>
                <li><a className='mx-3 text-emerald-500 hover:text-emerald-600 text-lg' href="https://github.com/ZachMcM"><i className="fa-brands fa-github"></i></a></li>
                <li><a className='mx-3 text-emerald-500 hover:text-emerald-600 text-lg' href="mailto:zachmcmullen04@gmail.com"><i className="fa-solid fa-envelope"></i></a></li>
            </ul>
            </section>
            <section className="my-10">
                ...
                <Link to={'/projects'} className='p-4 bg-gradient-to-r from-teal-600 to-green-400 rounded-md hover:opacity-60 duration-700 text-white'>All Projects</Link>
            </section>
        </main> 
    )
}